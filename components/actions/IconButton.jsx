...
export function IconButton({
  ...
  const handlers = disabled ? {} : {
    onMouseEnter: (e) => {
      ...
      else { t.style.background = 'var(--gold-a16)'; t.style.borderColor = 'var(--gold-400)'; }
    },
    onMouseLeave: (e) => {
      const t = e.currentTarget;
  ...
  return (
    <button aria-label={ariaLabel} onClick={disabled ? undefined : onClick} disabled={disabled} style={base} {...handlers} {...rest}>
      {children}
    </button>
  );
}
