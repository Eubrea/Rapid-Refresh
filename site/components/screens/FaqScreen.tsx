...
export function FaqScreen() {
  ...
  const faqs: [string, string][] = [
    ...
    ['What should I expect during a visit?', 'Your nurse arrives with everything needed, reviews your intake and consent, and administers your drip in comfort. Most sessions take 30 to 60 minutes depending on the drip and boosters selected.'],
    ['Is it safe? Are you insured?', 'Yes. RapidRefresh is a fully insured mobile practice delivering evidence-based, medical-grade therapy. Your health intake is reviewed before every treatment to ensure it is appropriate for you.'],
    ...
    ['Do you offer memberships and gift cards?', 'Yes. The Wellness Club offers monthly drips and member pricing from $179 per month, and digital gift cards are available in any amount and never expire.'],
  ];
      ...
      <section style={{ background: 'var(--navy-900)', padding: 'clamp(56px,6vw,96px) var(--gutter) var(--section-y)' }}>
        <div style={{ maxWidth: 'var(--container-text)', margin: '0 auto', textAlign: 'center' }}>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <SectionLabel align="center">Questions &amp; Answers</SectionLabel>
          </div>
          <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 300, fontSize: 'var(--fs-d1)', color: 'var(--ivory)', letterSpacing: '-0.02em', margin: '20px auto 0', maxWidth: '18ch' }}>
      ...
      <section style={{ background: 'var(--ivory)', padding: 'var(--section-y) var(--gutter)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: 56 }}>
            ...
            <p style={{ color: 'var(--slate-ink)', fontSize: 'var(--fs-lg)', margin: '14px auto 28px', maxWidth: '42ch' }}>
              We are happy to help you choose the right drip or plan a visit.
            </p>
