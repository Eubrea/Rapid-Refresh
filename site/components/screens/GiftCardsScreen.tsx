...
export function GiftCardsScreen() {
  ...
  const steps: [IconName, string, string][] = [
    ...
    ['mail', 'Personalize & send', 'Add a note and we will deliver a beautiful digital card by email.'],
        ...
        <div className="rr-split" style={{ maxWidth: 'var(--container)', margin: '0 auto', gridTemplateColumns: '1.05fr 0.95fr' }}>
          <div>
            ...
            <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 300, fontSize: 'var(--fs-d1)', color: 'var(--ivory)', letterSpacing: '-0.02em', margin: '20px 0 0', maxWidth: '18ch' }}>
              Give the gift of feeling exceptional.
            </h1>
            <p style={{ color: 'var(--ivory-a80)', fontSize: 'var(--fs-lg)', lineHeight: 1.6, margin: '22px 0 0', maxWidth: '50ch' }}>
              A RapidRefresh gift card is wellness they will actually use: concierge IV therapy delivered wherever they are.
            </p>
            ...
            {steps.map(([ic, t, d], i) => (
              <Reveal key={t} delay={i * 80}>
                <div style={{ background: 'var(--ivory-100)', borderRadius: 'var(--radius-xl)', padding: '32px 28px', height: '100%' }}>
                  <span style={{ width: 54, height: 54, borderRadius: '50%', background: 'var(--ivory)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-600)', boxShadow: 'var(--shadow-sm)' }}>
